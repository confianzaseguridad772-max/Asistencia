// Variables globales
let integrantes = [];
const urlApp = "https://script.google.com/macros/s/AKfycbxCNO2EvNomfIOmOBNmzNbRziRXCVPt3r9IXlwrO9hJiisUtiw0hkRSSHxCXwHprflrsQ/exec"; // Reemplaza con tu URL real
